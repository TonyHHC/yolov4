...
cfgFolder = "D:/Project/Tony/Python/yolov4/darknet/darknet/build/darknet/x64/tony_data_01/yolo_config"
dark_home = "D:/Project/Tony/Python/yolov4/darknet/darknet/build/darknet/x64"
...
with open(cmd_file, 'w') as file:
    for i, size in enumerate(sizes):
        ...
        nmap_out = subprocess.run([darknet_path, 'detector', 'calc_anchors', os.path.join(cfgFolder, 'face.data'), '-num_of_clusters', \
